  ...
  "themes": [
    {
      ...
      "style": {
        ...
        "scrollbar.thumb.background": "{{ lighter_background }}",
        "scrollbar.thumb.hover_background": "{{ accent }}",
        "scrollbar.thumb.active_background": "{{ blue }}",
        "scrollbar.thumb.border": "#00000000",
        "scrollbar.track.background": "#00000000",
        "scrollbar.track.border": "#00000000",
        "minimap.thumb.background": "{{ accent }}20",
        "minimap.thumb.hover_background": "{{ accent }}40",
        "minimap.thumb.active_background": "{{ blue }}60",
